...
肯定：
- Affirms, Reaffirms, Confirms;

强调：
- Emphasizes, Underlines;

谴责：
- Condemns, Deplores, Regrets;

赞赏：
- Endorses, Expresses its appreciation;

建议：
- Suggests, Calls upon/for, Recommends;

决定：
- Decides, Demands, Requests, Urges;

程度词：
- Further, Fully, Strongly, Deeply.

## 演讲常用词汇语句
- apartheid, racial segregation 种族隔离
- an established principle of international law 国际法准则- boundary negotiation 边界谈判
- bilateral and multilateral economic cooperation 双边和多边经济合作
- bilateral trade 双边贸易
- breadth of territorial sea 领海宽度
- consultations/negotiations 磋商
